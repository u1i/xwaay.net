...
* Comprehensive access to accounts and transactions for a consumer
* Integrated Consent Management
* Authorization Code Flow and support for single-page apps (SPA)
* Benefit 4

# Workflow

The figure below provides a general outline of an account information request and flow using the Account Info APIs. Please refer to the notes belore for a detailed explanation of the individual steps.

![](./flow1.gif)

# Use Cases

* Spend Control & Budgeting Apps
